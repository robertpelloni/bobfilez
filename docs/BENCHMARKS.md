...
| :--- | :--- | :--- | :--- |
| `ScannerFixture/ScanStd` | 1,498,936 | ~1.50 | Standard C++20 iterator |
| `ScannerFixture/ScanWin32` | 1,757,706 | ~1.76 | Native Win32 API |
...
| :--- | :--- | :--- | :--- |
| `BM_Hasher_Fast64` | 241,979 | **4.27 GiB/s** | Quick deduplication, change detection |
| `BM_Hasher_Blake3` | 1,692,073 | 585.14 MiB/s | Integrity verification, crypto-signing |
