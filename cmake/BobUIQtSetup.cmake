# Prefer the local BobUI Qt fork when GUI / Omni targets are enabled.
#
# BobUI is maintained as a Qt fork in this repository at:
#   libs/bobui
#
# The bobfilez GUI targets still consume standard Qt6 CMake package names
# (Qt6::Core, Qt6::Gui, etc.), but the preferred provider for those packages is
# BobUI rather than a separately installed stock Qt.

set(FO_BOBUI_ROOT "${CMAKE_SOURCE_DIR}/libs/bobui" CACHE PATH
    "Path to the BobUI (Qt fork) source/build/install root")
...
function(fo_configure_bobui_qt)
    ...
    foreach(_bobui_root IN LISTS _bobui_roots)
        list(APPEND _bobui_prefix_hints
            ...
            "${_bobui_root}/qtbase"
            "${_bobui_root}/qtbase/lib/cmake"
            "${_bobui_root}/qtbase/lib/cmake/Qt6"
        )
    endforeach()
